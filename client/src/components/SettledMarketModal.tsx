...
export function SettledMarketModal({ isOpen, onClose }: SettledMarketModalProps) {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("Prediction already settled");
    setCopied(true);
        ...
        <div className="terminal-wrap">
          <div className="terminal">
            <hgroup className="terminal-head">
              ...
              <button 
                className={`copy-toggle ${copied ? 'copied' : ''}`} 
                tabIndex={-1} 
                type="button"
                onClick={handleCopy}
            ...
            <div className="terminal-body">
              <pre className="terminal-pre">
                <code>-&nbsp;</code>
                <code>sads&nbsp;</code>
                <code className="terminal-cmd" data-cmd="prediction-already-settled"></code>
              </pre>
            </div>
          </div>
        </div>
